...
with
\begin{align*}
	y^\prime         & = f\big(t,y\big)                               \\
	y^{\prime\prime} & = \frac{\mathrm{d}}{\mathrm{d}t}f\big(t,y\big)
	= f_t\big(t,y(t)\big) + f_y\big(t,y(t)\big) y^\prime(t)
	= f_t\big(t,y(t)\big) + f_y\big(t,y(t)\big) f\big(t,y(t)\big).
\end{align*}
Thus
\begin{align*}
	y(t+h) & = y^j + h\, f(t,y^j) + \frac{h^2}{2}\Big(f_t(t,y^j) + f_y(t,y^j)\,f(t,y^j)\Big)+\mathcal{O}(h^3)
\end{align*}

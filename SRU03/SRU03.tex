...
\begin{align}
	...
	+ 
	\sum_{l=0}^{{m}} \Bigg( \alpha_l\sum_{n=1}^{q} \frac{x^{(n)}(t_j)\,(lh)^{n}}{n!} \Bigg)
	+ 
	\sum_{l=0}^{{m}}\alpha_l\,\underbrace{\mathcal{O}((lh)^{q+1})}_{\mathcal{O}(h^{q+1})}
	\notag                                                     \\ 
	 & \qquad 
	- \sum_{l=0}^{{m}} \Bigg( h\,\beta_l \sum_{n=1}^{r} \frac{n\,x^{(n)}(t_j)\,l^{n-1}h^{n}}{n!\,h}  \Bigg)
	...
	- h\,\beta_l \sum_{n=1}^{r} \frac{n\,x^{(n)}(t_j)\,l^{n-1}h^{n}}{n!\,h} 
	\Bigg) \notag                                              \\
	 & \qquad\qquad\qquad\qquad\qquad\qquad
	+ \sum_{l=0}^{{m}}
	\Bigg(
	\underbrace{\alpha_l\,\mathcal{O}(h^{q+1}) - \beta_l\,\mathcal{O}(h^{r})}_{\gamma_l\mathcal{O}(h^{q+1})}
	\Bigg) = 0
	\notag                                                     \\
	\Leftrightarrow
	 & \sum_{l=0}^{{m}}\alpha_l\,x(t_j) 
	...
	- \beta_l \sum_{n=1}^{r} \frac{n\,x^{(n)}(t_j)\,l^{n-1}h^{n}}{n!} 
	\Bigg) \notag                                              \\

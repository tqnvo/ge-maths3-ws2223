...
Mathe III $\cdot$ SRU03 $\cdot$ Response to questions $\cdot$ WS22/23 
\hspace{280pt} 
...
\end{observationboxed}
\begin{observationboxed}
	The apprearance of the green term $\textcolor{ForestGreen}{f(t_j+mh,x(t_j+mh))}$
...
\begin{observationboxed}
	...
	\begin{align}
		...
		x(t) 
		 & = x(a) 
		+ \frac{x'(a)(t-a)}{1!} + \frac{x''(a)(t-a)^2}{2!} + \dots + \frac{x^{(n)}(a)(t-a)^n}{n!}\notag                 \\
		 & \quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad 
		+ \mathcal{O}((t-a)^{n+1})                                                                               \notag \\
		 & = \sum_{j=0}^{n} \frac{x^{(n)}(a)(t-a)^{n}}{n!} + \mathcal{O}((t-a)^{n+1}).
	\end{align}
	...
	\begin{align}
		...
		x(a+h) 
		 & = x(a) 
		+ \frac{x'(a)h}{1!} + \frac{x''(a)h^2}{2!} + \dots + \frac{x^{(n)}(a)h^n}{n!}
		+ \mathcal{O}(h^{n+1})                                                 \notag \\
		 & = \sum_{j=0}^{n} \frac{x^{(n)}(a)h^{n}}{n!} + \mathcal{O}(h^{n+1}),
	\end{align}
	which gives rise to 
	\begin{align}
		...
		x'(a+h) 
		 & = x'(a) 
		+ \frac{x''(a)h}{1!} + \frac{x'''(a)h^2}{2!} + \dots + \frac{x^{(n+1)}(a)h^n}{n!}
		+ \mathcal{O}(h^{n+1})                                                 \notag \\
		 & = \sum_{j=0}^{n} \frac{x^{(n+1)}(a)h^{n}}{n!} + \mathcal{O}(h^{n+1}),
	\end{align}
\end{observationboxed}
\begin{align}
	x(t_j+lh) = x(t_j)

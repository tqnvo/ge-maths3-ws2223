...
\begin{exampleboxed}
	Given the set $A \in \mathbb{R}^2$ as follows
	\inputfig{floats/setAinR2}{setAinR2}
\end{exampleboxed}

Equation of a line through two points is given by 
\begin{align}
	y - y_{A} = 
\end{align}
where $x_A$ and $y_A$ are the coordinate of point $A$, and 
$x_B$ and $y_B$ are the coordinate of point $B$.

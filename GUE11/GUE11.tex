		      ...
		      \item By using $\Bn$
		            \begin{align}
			            \boxed{
				            \begin{aligned}
					            \bigintsss_F
					            \Big\langle \Bf , \Bn \Big\rangle \,d\sigma
					             & 
					            = \bigintsss_0^1 \!\!\! \bigintsss_0^{2\pi}
					            \Big\langle \Bf\big(F(\alpha,\beta)\big), \Bn \Big\rangle
					            \,d\beta \, d\alpha 
					            \\
					            %  & = \bigintsss_0^1 \!\!\! \bigintsss_0^{2\pi}
					            % \begin{pmatrix}
...
\begin{enumerate}[(i)]
	...
	\item Since the area $B$ is bounded by the three curves, we obtain the following relations
	      ...
	      \begin{align}
		    ...
		    %   \bigintsss_{\gamma_2(t)} \bm{f}(\gamma_2'(t)) \cdot\bm{\nu}_2 \, dt +
		    %   \bigintsss_{\gamma_3(t)} \bm{f}(\gamma_3'(t)) \cdot\bm{\nu}_3 \, dt
		    %   \\
		       & =\bigintsss_0^1

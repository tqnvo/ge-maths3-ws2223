...
\begin{exampleboxed}
	...
	\begin{align}
		...
		\right\},
	\end{align}
	and the vector field  $f$ given by
	$f(x,y,z) = \Big( x\sqrt{y^2+z^2}, y, z \Big)$.
\end{exampleboxed}
Approach:
...
\begin{enumerate}[(i)]
	\item The normal vector of the surface is computed as follows
	      ...
	      \begin{observationboxed}
		      Be aware of the sign when using \textbf{cofactor method} to compute the determinant 
		      \begin{align}
			      \partial_{\alpha} F \times \partial_{\beta} F
			       & =
			      \begin{vmatrix}
	      ...
	      \begin{align}
		      \|\tilde{\nu}\|
		      = \Big(\alpha^2 + \alpha^2\cos^2(\beta)e^{2\alpha} + \alpha^2\sin^2(\beta)e^{2\alpha}\Big)^{1/2}
		      = \alpha\Big(1+e^{2\alpha}\Big)^{1/2}.
	      \end{align}
	      Unter Ber"ucksichtigung des Vorzeichens der ersten Komponente
	      folglich ist
	      \begin{align}
		      \boxed{
			      \nu
	...
	\item Oberflächenintegral 2. Art
	      \begin{align}
		      \boxed{
			      \begin{aligned}
				      \bigintsss_F
				      ...
				      \Big\langle f\big(F(\alpha,\beta)\big), \tilde{\nu} \Big\rangle
				      \,d\beta \, d\alpha                    \\
				       & = \bigintsss_0^1\bigintsss_0^{2\pi}
				      \begin{pmatrix}

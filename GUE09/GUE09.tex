...
% Wir können $\Gamma_2$ gem"ass
% \begin{align*}
% 	\boxed{
% 		\Gamma_2(t) := (t, t) \text{ für } t \in [0,1] \Rightarrow \gamma_2' = (1, 1)^T
% 	}
% \end{align*}
% angeben. Einsetzen in $f$ ergibt
% \begin{align*}
% 	f(\Gamma_2(t)) = (t e^t, \sin(t) + t)^T.
% \end{align*}
% Das Arbeitsintegral berechnet sich nun durch
% \begin{align*}
% 	\bigintsss_{\Gamma_2} f \cdot dx
% 	 & =  \bigintsss_0^1 \left< f(\gamma_2(t)), \gamma_2'(t) \right> dt
% 	=  \bigintsss_0^1 \left( te^t + sin(t) + t \right) \, dt                           \\
% 	 & =  \Big[\frac{1}{2} t^2\Big]_0^1 + \Big[- \cos(t)\Big]_0^1 + \Big[te^t\Big]_0^1
% 	- \bigintsss_0^1 e^t \, dt                                                         \\
% 	 & =  \frac{1}{2} - \cos(1) + 1 + e^1 - \Big[e^t\Big]_0^1
% 	=  \frac{1}{2} - \cos(1) + 1 + e^1 - e^1 + 1
% \end{align*}
% Daher
% \begin{align*}
% 	\therefore\quad\boxed{
% 		\bigintsss_{\Gamma_2} f \cdot dx = \frac{5}{2} - \cos(1).
% 	}
% \end{align*}
